...
export default {
  ...
  methods: {
    async book (id) {
      ...
      await axios.post(`https://hcsm.herokuapp.com/api/guest/reservations?checkinDate=${this.checkin}&checkoutDate=${this.checkout}&room=${id}`, null, {
        headers: {
    ...
    async getHotels () {
      ...
      const h = await axios.get('https://hcsm.herokuapp.com/api/guest/hotels', {
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${localStorage.getItem('token')}`
        }
    ...
    async getRoomTypes (id) {
      ...
      const h = await axios.get(`https://hcsm.herokuapp.com/api/guest/roomTypes?hotel=${id}`, {
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${localStorage.getItem('token')}`
        }
    ...
    async getRooms (id) {
      ...
      const h = await axios.get(`https://hcsm.herokuapp.com/api/guest/rooms?roomType=${id}`, {
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${localStorage.getItem('token')}`
        }
